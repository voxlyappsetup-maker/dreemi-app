...
- FastSpring historical: Individual Monthly test checkout **PASS on retry**; activation/onboarding progressed then **final decline received**. Clarified blocker: **generative AI** (subscription model **not** the issue). Category clarification **SENT 2026-07-11**; response **RECORDED**; user acknowledgment **SENT 2026-07-15**. FastSpring runtime **FROZEN**. Lemon Squeezy **unavailable/rejected**. PayPro Global preflight **SENT 2026-07-11** — response **PENDING**; Paddle/Creem **NOT SENT**. Future preflight must test generative-AI SaaS acceptance. Production billing **NO-GO**.

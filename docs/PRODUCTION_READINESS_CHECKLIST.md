...
- FastSpring catalog dashboard setup record created (`docs/D3M_FASTSPRING_CATALOG_DASHBOARD_SETUP_RECORD.md`); setup **NOT_STARTED** / unconfirmed. Payment blocked until catalog confirmed, website alignment, test checkout, webhook integration, entitlement mapping, Live approval, and payout readiness. Production billing **NO-GO**.

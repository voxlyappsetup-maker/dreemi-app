...
- FastSpring catalog **planned** (`docs/D3M_FASTSPRING_CATALOG_PLAN.md`); not configured in dashboard. Payment provider remains testing/trial only; checkout/webhook/entitlement integration and Live activation remain pending. Production billing **NO-GO**.

...
- FastSpring contact pack near send-ready (`docs/D3M_FASTSPRING_PREFLIGHT_CONTACT_PACK.md`); founder/Privacy/Terms filled; eligibility/approval/checkout/webhook pending. Production billing **No-Go**.

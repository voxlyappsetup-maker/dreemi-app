...
- FastSpring trial/test store exists (`docs/D3M_FASTSPRING_TRIAL_STORE_SETUP_RECORD.md`); **not Live**. Live activation, tax/KYC, catalog, test checkout, webhook integration, and payout remain pending. Production billing **NO-GO**.

...
- FastSpring catalog dashboard setup **COMPLETE** for Individual/Family monthly/yearly (`docs/D3M_FASTSPRING_CATALOG_DASHBOARD_SETUP_RECORD.md`). Payment blocked until website alignment, test checkout, webhook integration, entitlement mapping, Live approval, and payout readiness. Production billing **NO-GO**.

...
- FastSpring remains **primary candidate only**; eligibility preflight documented (`docs/D3M_FASTSPRING_ELIGIBILITY_PREFLIGHT.md`). Application, approval, checkout, and webhook verification remain pending. Production billing **No-Go**.

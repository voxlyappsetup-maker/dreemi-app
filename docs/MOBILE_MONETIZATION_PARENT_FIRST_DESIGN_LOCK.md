...
- Cross-reference Apple IAP readiness planning:
...
- Android monetization remains parent-facing and Google product IDs/base plans remain placeholders until a later approved finalization phase.

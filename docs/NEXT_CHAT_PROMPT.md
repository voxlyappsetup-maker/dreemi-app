...
- The next recommended entitlement phase is Phase 4-D3I only after D3H is committed and accepted.
- D3I must be proposal/review only for selecting the next runtime surface, not immediate implementation.
